...
void VECT3_BOUND_CUBE(T1 &_v, T2 _min, T2 _max) {
    if ((_v).x > (_max)) 
        (_v).x = (_max); 
    else if ((_v).x < (_min)) 
        (_v).x = (_min);
...
/* Joezie: macro=>func */
template <typename T1, typename T2>
void VECT3_BOUND_BOX(T1 &_v, T2 _v_min, T2 _v_max) {
    if ((_v).x > (_v_max).x) 
        (_v).x = (_v_max).x; 
    else if ((_v).x < (_v_min).x) 
        (_v).x = (_v_min).x; 

    if ((_v).y > (_v_max).y) 
        (_v).y = (_v_max).y; 
    else if ((_v).y < (_v_min).y) 
        (_v).y = (_v_min).y; 

    if ((_v).z > (_v_max).z) 
        (_v).z = (_v_max).z; 
    else if ((_v).z < (_v_min).z) 
        (_v).z = (_v_min).z; 
}
...
/* Joezie: macro=>func */
template <typename T1, typename T2>
void EULERS_BOUND_CUBE(T1 &_v, T2 _min, T2 _max) { 
...
/* Joezie: macro=>func */
template <typename T1, typename T2>
void RATES_BOUND_CUBE(T1 &_v, T2 _min, T2 _max) {
...
/* Joezie: macro=>func */
template <typename T1, typename T2>
void RATES_BOUND_BOX(T1 &_v, T2 _v_min, T2 _v_max) {
    if ((_v).p > (_v_max).p) 
        (_v).p = (_v_max).p; 
    else if ((_v).p < (_v_min).p) 
        (_v).p = (_v_min).p; 

    if ((_v).q > (_v_max).q) 
        (_v).q = (_v_max).q; 
    else if ((_v).q < (_v_min).q) 
        (_v).q = (_v_min).q; 

    if ((_v).r > (_v_max).r) 
        (_v).r = (_v_max).r; 
    else if ((_v).r < (_v_min).r) 
        (_v).r = (_v_min).r; 
}

/* Joezie: macro=>func */
template <typename T1, typename T2>
void RATES_BOUND_BOX_ABS(T1 &_v, T2 _v_max) {       
    if ((_v).p > (_v_max).p) 
        (_v).p = (_v_max).p; 
    else if ((_v).p < -(_v_max).p) 
        (_v).p = -(_v_max).p; 

    if ((_v).q > (_v_max).q) 
        (_v).q = (_v_max).q; 
    else if ((_v).q < -(_v_max).q) 
        (_v).q = -(_v_max).q; 

    if ((_v).r > (_v_max).r) 
        (_v).r = (_v_max).r; 
    else if ((_v).r < -(_v_max).r) 
        (_v).r = -(_v_max).r; 
}
