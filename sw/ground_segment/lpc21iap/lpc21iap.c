...
=======
    // joezie 2019/10/9
    //binElf = malloc(lenElf);
    binElf = (unsigned char*)malloc(lenElf);
...
=======
    // joezie 2019/10/9
    //startBuf = malloc(sizeof(tIntermediateBuffer));
    startBuf = (tIntermediateBuffer*)malloc(sizeof(tIntermediateBuffer));
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
    if (startBuf == NULL)
    {
        perror("malloc failed");
...
=======
                                // joezie 2019/10/9
                                //actBuf->next = malloc(sizeof(tIntermediateBuffer));
                                actBuf->next = (tIntermediateBuffer*)malloc(sizeof(tIntermediateBuffer));
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
                                if (actBuf->next == NULL)
                                {
                                    perror("malloc failed");
...
=======
                                // joezie 2019/10/9
                                //actBuf = actBuf->next;
                                actBuf = (tIntermediateBuffer*)actBuf->next;
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
