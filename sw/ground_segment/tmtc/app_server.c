...
=======
        //joezie 2019/10/9
        //GOutputStream * ostream = g_io_stream_get_output_stream (ConnectedClients[i].ClientTcpData);
        GOutputStream * ostream = g_io_stream_get_output_stream ((GIOStream *)ConnectedClients[i].ClientTcpData);
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
...
=======
      //joezie 2019/10/9
      //udpSocket = g_socket_new(G_SOCKET_FAMILY_IPV4, G_SOCKET_TYPE_DATAGRAM, 17, NULL);
      udpSocket = g_socket_new(G_SOCKET_FAMILY_IPV4, G_SOCKET_TYPE_DATAGRAM, (GSocketProtocol)17, NULL);
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
...
=======
    //joezie 2019/10/9
    //GSocketAddress *sockaddr = g_socket_connection_get_remote_address(data, NULL);
    GSocketAddress *sockaddr = g_socket_connection_get_remote_address((GSocketConnection*)data, NULL);
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
...
=======
        // joezie 2019/10/9
        //GOutputStream * ostream = g_io_stream_get_output_stream (data);
        GOutputStream * ostream = g_io_stream_get_output_stream ((GIOStream*)data);
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
