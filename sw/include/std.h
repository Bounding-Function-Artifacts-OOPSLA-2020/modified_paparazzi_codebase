...
=======
//#define BoundUpper(_x, _max) { if (_x > (_max)) _x = (_max);}
void BoundUpper(double _x, double _max) {}


//#define Bound(_x, _min, _max) { if (_x > (_max)) _x = (_max); else if (_x < (_min)) _x = (_min); }
void Bound(double _x, double _min, double _max) {}
...
void BoundInverted(double _x, double _min, double _max) {}
...
//        BoundInverted(_x, _min, _max)             \
//      }
void BoundWrapped(double _x, double _min, double _max) {}

//#define BoundAbs(_x, _max) Bound(_x, -(_max), (_max))
void BoundAbs(double _x, double _max) {}

//#define Clip(_x, _min, _max) ( (_x) < (_min) ? (_min) : (_x) > (_max) ? (_max) : (_x) )
double Clip(double _x, double _min, double _max) {return _x;}

//#define ClipAbs(x, max) Clip(x, -(max), (max))
double ClipAbs(double _x, double _max) {return _x;}
...
//      _x = 0;                         \
//  }
void DeadBand(double _x, double _v) {}
>>>>>>> 5926b573a907e168704d2426ee3d50a02e32d1b3
